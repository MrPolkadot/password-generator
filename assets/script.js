...
function generatePassword(length, lower, upper, numeric, special) {
  prompt("Character length( At least 8 characters and no more than 128 characters");
  prompt("Include lowercase? (y/n)");
  prompt("Include uppercase? (y/n)");
